...
1. Useful functions to get to know are table, margin.table, prop.table, ftable, xtabs, apply, using integer indexing to re-order categories and pivot the dimensions
