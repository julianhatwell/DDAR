...
* Over 15 years in enterprise and management information systems in the for-profit education sector, UK and Singapore
* Completed $> 20$ MOOCs (certified) in data science related subjects 2014-2016
* MSc (Distinction) Business Intelligence, Birmingham City University, 2017
...
dimnames(MSP) <- list(prd = c("Certain",  "Probable", "Possible", "Doubtful"), tru = c("Certain",  "Probable", "Possible", "Doubtful"))
```
